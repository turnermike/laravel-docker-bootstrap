...
$(document).ready(function(){
  ...
  // try{
    ...
    var auto_complete_options = {
        // url: '/portal/test.json',
        // url: '/portal/' + locale + '/get-retailers',
        data: test_data,
    ...
    //  */
    // // easy autocomplete ajax request
    // var auto_complete_options = {

    //     url: function(phrase) {
    //         return '/portal/' + locale + '/get-retailers';
    //     },

    //     getValue: function(element) {
    //         return element.store_name;
    //     },
    ...
    //             var fio_id = $('#txtMenuSearch').getSelectedItemData().fio_id;
    //             // console.log('target', window.location.hostname + '/portal/retailer/?fio_id=' + fio_id);
    ...
    // /**
    //  * Demo ajax request to get-retailers (dev)
    //  */
    // $.ajax({
    //     type: 'POST',
    //     url: '/portal/' + locale + '/get-retailers',
